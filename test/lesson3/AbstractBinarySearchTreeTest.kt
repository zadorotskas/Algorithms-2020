...
abstract class AbstractBinarySearchTreeTest {
    ...
    protected fun doRemoveTest() {
        ...
        for (iteration in 1..100) {
            ...
            assertRemoveTest(binarySet, controlSet, toRemove)
        }
        val binarySet = create()
        val controlSet = mutableSetOf<Int>()
        assertFalse(
            binarySet.remove(777)
        )
        for (i in 1..1000) {
            binarySet.add(i)
            controlSet.add(i)
    ...
    private fun assertRemoveTest(binarySet: CheckableSortedSet<Int>, controlSet: MutableSet<Int>, toRemove: Int) {
    ...
    protected fun doIteratorTest() {
        ...
        assertIteratorTest(TreeSet<Int>())
        ...
        assertIteratorTest(controlSet)
    }

    private fun assertIteratorTest(controlSet: MutableSet<Int>) {
        println("Control set: $controlSet")
        val binarySet = create()
        assertFalse(
    ...
    protected fun doIteratorRemoveTest() {
        ...
        for (iteration in 1..100) {
            ...
            assertIteratorRemoveTest(controlSet, toRemove)
        }
    ...
    private fun assertIteratorRemoveTest(controlSet: MutableSet<Int>, toRemove: Int) {
        println("Initial set: $controlSet")
        val binarySet = create()
        for (element in controlSet) {
            binarySet += element
